...
public:
    ...
    transport::RouterSettings FillRoutingSettings(const json::Node& settings) const;

    transport::Router FillRoutingSettings(const json::Node& settings, const transport::Catalogue& catalogue) const;
