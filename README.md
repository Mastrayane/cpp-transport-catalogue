...
## Планы по доработке
### Текущие задачи:
- Вводные данные по дизайну сейчас заданы по умолчанию для всех параметров кроме цветовой гаммы. Сделать возможность задавать как по умолчанию, так и произвольно.
- Улучшить графический дизайн элементов карты (обоводки, тени, повышение читабельности.
- Реализовать реальную расстановку остановок по координатам широты и долготы с применением масштабирования.
- Рефакторинг кода:
